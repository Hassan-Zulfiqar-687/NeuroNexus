...
import com.example.neuronexus.adapters.OnboardingAdapter
import com.example.neuronexus.models.OnboardingItem
import com.example.neuronexus.utils.ZoomOutPageTransformer
        ...
        viewPager.registerOnPageChangeCallback(object : ViewPager2.OnPageChangeCallback() {
            override fun onPageSelected(position: Int) {
                ...
                if (position == adapter.itemCount - 1) {
                    ...
                    buttonSkip.visibility = View.INVISIBLE // Hide Skip on last page
                } else {
